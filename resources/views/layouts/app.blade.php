...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-white text-erentBlack">
        ...
        <footer class="w-full bg-[#c5c5c5] p-4">
            <div class="w-full max-w-[1440px] mx-auto flex flex-wrap justify-evenly gap-8 md:gap-16">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <ul>
                        <li><a href="/" class="hover:opacity-90 active:opacity-85">FAQ</a></li>
                        <li><a href="/" class="hover:opacity-90 active:opacity-85">Support Center</a></li>
                        <li><a href="/" class="hover:opacity-90 active:opacity-85">Terms & Conditions</a></li>
                        <li><a href="/" class="hover:opacity-90 active:opacity-85">Privacy Policy</a></li>
                    </ul>
                </div>
                <div class="flex flex-col gap-2">
